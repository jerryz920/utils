...
sleep 0.1
curl http://10.10.1.39:19851/attestInstance -d "{ \"principal\": \"152.3.145.138:4144\",  \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$base\", \"noconfig\"]}"
sleep 0.1
curl http://10.10.1.39:19851/attestInstance -d "{ \"principal\": \"152.3.145.138:4144\",  \"bearerRef\": \"$inst_id\",\"otherValues\": [\"1.1.1.1:$base-$base2\", \"noconfig\"]}"
sleep 0.1
curl http://10.10.1.39:19851/attestAppProperty -d "{ \"principal\": \"152.3.145.138:4144\", \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$base\", \"noconfig\", \"git://github.com/jerryz920/docker\"]}"
sleep 0.1
curl http://10.10.1.39:19851/attestAppProperty -d "{ \"principal\": \"152.3.145.138:4144\",  \"bearerRef\": \"$inst_id\",\"otherValues\": [\"1.1.1.1:$((base+5))\", \"noconfig\", \"git://github.com/jerryz920/docker\"]}"
sleep 0.1
curl http://10.10.1.39:19851/attestAppProperty -d "{ \"principal\": \"152.3.145.138:4144\", \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$base2\", \"noconfig\", \"git://github.com/jerryz920/docker\"]}"
sleep 0.1
echo
echo should be rejected
sleep 0.1
curl http://10.10.1.39:19851/appAccessesObject -d "{ \"principal\": \"152.3.145.138:4144\", \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$base\", \"noconfig\", \"alice:object1\"]}"
sleep 0.1
curl http://10.10.1.39:19851/appAccessesObject -d "{ \"principal\": \"152.3.145.138:4144\", \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$((base+5))\", \"noconfig\", \"alice:object1\"]}"
sleep 0.1
curl http://10.10.1.39:19851/appAccessesObject -d "{ \"principal\": \"152.3.145.138:4144\", \"bearerRef\": \"$inst_id\", \"otherValues\": [\"1.1.1.1:$base2\", \"noconfig\", \"alice:object1\"]}"
...
curl http://10.10.1.39:19851/postImageProperty -d "{ \"principal\": \"$IAAS_IP\",  \"otherValues\": [\"instance-image-hash2\", \"git://github.com/jerryz920/notmysql\"]}"
...
curl http://10.10.1.39:19851/postAttesterImage -d "{ \"principal\": \"$IAAS_IP\",  \"otherValues\": [\"instance-image-hash3\"]}"
...
curl http://10.10.1.39:19851/postImageProperty -d "{ \"principal\": \"$IAAS_IP\",  \"otherValues\": [\"instance-image-hash3\", \"git://github.com/jerryz920/mysql\"]}"
